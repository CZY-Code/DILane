...
from dilane.datasets.process.transforms import DILTransforms
...
class GenerateLaneLine(object):
    def __init__(self, transforms=None, cfg=None, training=True):
        ...
        if transforms is None:
            transforms = DILTransforms(self.img_h, self.img_w)
    ...
    def transform_annotation(self, anno, img_wh=None):
        ...
        for lane_idx, lane in enumerate(old_lanes):
            ...
            lanes[lane_idx, 3] = xs_inside_image[0] #startx
    ...
    def __call__(self, sample):
        ...
        sample['lane_line'] = label #78个点用于回归
        sample['lanes_endpoints'] = lane_endpoints
        sample['gt_points'] = new_anno['lanes'] #将图缩小到[320, 800]后的点list(array)
