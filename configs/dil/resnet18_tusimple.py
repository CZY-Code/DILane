...
work_dirs = "work_dirs/dil/r18_tusimple"
...
val_process = [
    dict(type='GenerateLaneLine',
         ...
         training=False),
    dict(type='ToTensor', keys=['img', 'lane_line']), #['img']
]


dataset_path = '/home/chengzy/dataset/Tusimple'
dataset_type = 'TuSimple'
test_json_file = '/home/chengzy/dataset/Tusimple/test_label.json'
